...
Route::group(['prefix'=>'admin'], function(){
    ...
    Route::group(['middleware'=>'admin.auth'],function(){
        ...
        Route::put('/brands/{brand}/edit',[BrandController::class,'update'])->name('brands.update');
        ...
        Route::post('/product-images/delete',[ProductImageController::class,'destroy'])->name('product-images.destroy');
