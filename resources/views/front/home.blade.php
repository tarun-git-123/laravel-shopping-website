            ...
            <div class="row pb-3">
                @if (getCategories()->isNotEmpty())
                    @foreach (getCategories() as $category)
                        <div class="col-lg-3" width="200" height="300">
                            <div class="cat-card">
                                <div class="left">
                                    <img src="{{ asset('uploads/category/thumb/'.$category->image)}}" alt="{{ $category->image }}" class="img-responsive" style="height:140px !important">
                                </div>
                                <div class="right">
                                    <div class="cat-data">
                                        <h2>{{ $category->name}} </h2>
